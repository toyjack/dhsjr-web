  ...
  return (
    <section className="p-4">
      <article className="prose max-w-none">
        ...
        <p>
          DHSJRの公開データセット
          <Link href="https://github.com/daikaku/DHSJR" target="_blank">
            (https://github.com/daikaku/DHSJR)
          </Link>
          を利用しています。公開レポジトリと同期に更新します。
        </p>
        <p>
      ...
      <article className="prose max-w-none">
        ...
        <h3>参加研究者（50音順）</h3>
        <p>
          研究分担者：浅田健太朗（島根大学）、石山裕慈（神戸大学）、大島英之（早稲田大学次席研究員）、岡島昭浩（大阪大学）、加藤大鶴（早稲田大学）、坂水貴司（広島経済大学）、佐々木勇（広島大学）、鈴木裕也（信州大学）、高田智和（国立国語研究所）、中澤信幸（山形大学）、守岡知彦（国文学研究資料館）、肥爪周二（東京大学）、劉冠偉（京都大学人文科学研究所）
        </p>
        <p>研究協力者：鄭門鎬（京都先端科学大学）</p>
